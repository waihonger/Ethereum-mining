...
cd /opt/Ethereum-mining
sudo wget https://www.dropbox.com/s/e5td3rsd09bkkln/claymore97-latest.tar.gz
sudo tar -xvzf claymore97-latest.tar.gz -C Claymore-miner/
